...
type MockResourceRecordSetClient struct {
	...
	MockGetResourceRecordSet                  func(ctx context.Context, c rr.Client, id, rrName *string) (route53.ResourceRecordSet, error)
	MockGenerateChangeResourceRecordSetsInput func(p *v1alpha3.ResourceRecordSetParameters, action route53.ChangeAction) *route53.ChangeResourceRecordSetsInput
}
...
func (m *MockResourceRecordSetClient) GetResourceRecordSet(ctx context.Context, c rr.Client, id, rrName *string) (route53.ResourceRecordSet, error) {
	return m.MockGetResourceRecordSet(ctx, c, id, rrName)
}

// GenerateChangeResourceRecordSetsInput mocks GenerateChangeResourceRecordSetsInput method
func (m *MockResourceRecordSetClient) GenerateChangeResourceRecordSetsInput(p *v1alpha3.ResourceRecordSetParameters, action route53.ChangeAction) *route53.ChangeResourceRecordSetsInput {
